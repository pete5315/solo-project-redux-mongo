...
function* newGame(action) {
  ...
  try {
    ...
    yield axios.post('/api/atlas/list/addgame/' + action.payload.listId, {newGame: action.payload.newGame, id: action.payload.id, url: action.payload.url, thumbnail: action.payload.thumbnail}, config);
